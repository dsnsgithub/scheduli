...
function createInactiveDay(days: any, description: string, schedule: any, setSchedule: Function) {
	const newSchedule = { ...schedule };

	const index = newSchedule["about"]["inactiveDays"].findIndex((newItem: { days: string | string[] }) => {
	...
	// @ts-ignore
	newSchedule["about"]["inactiveDays"].sort((a: any, b: any) => customDateSort(a) - customDateSort(b));
								...
								<button
									...
									onClick={() => {
										if (currentSelection == 0) {
											createInactiveDay(selectedDate, inactiveName, props.schedule, props.setSchedule);
										} else {
											createInactiveDay([selectedDate1, selectedDate2], inactiveName, props.schedule, props.setSchedule);
										}
