      ...
      {isOpen && (
        <div className="lg:hidden absolute top-0 right-0 mt-16 w-full bg-wedgewood-100 shadow-md p-4 rounded-lg border border-wedgewood-600">
          <div className="flex flex-row-reverse mb-4">
            <button
              onClick={toggleMenu}
              className="focus:outline-none text-wedgewood-600 border border-wedgewood-600 rounded-full w-10 h-10 flex items-center justify-center"
            >
          ...
          <div className="flex flex-col items-center">
            <Link
              className="p-4 border-wedgewood-300 bg-wedgewood-200 border-2 rounded w-full text-center m-2 font-bold"
              href="/"
            >
