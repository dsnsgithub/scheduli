import { ParsedEvent, Schedule as ScheduleType } from "@scheduli/types";
...
export default function Schedule(props: {
  scheduleTimes: ParsedEvent[];
  scheduleDB: ScheduleType;
}) {
  return (
    <>
      <table className="w-full text-sm text-center bg-wedgewood-300 border-2 rounded-lg overflow-hidden shadow-md">
        ...
        <tbody className="bg-wedgewood-200">
          {props.scheduleTimes.map(({ startTime, endTime, periodName }) => {
            return (
